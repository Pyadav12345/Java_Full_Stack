...
public class Tester1005LambdaToMRReductionRule2 {
	...
	public static void req2() {
		...
		// Product
		TwoParameterProductObjectInterface printProduct3 = (product, productId, name) -> product.printProductDetails(productId, name);
		...
		// customer
		TwoParameterCustomerObjectInterface printCustomer3 = (customer, customerId, name) -> customer.printCustomerDetails(customerId, name);
