...
public class EmployeeDAOIMPL implements EmployeeDAO {
	...
	public List<EmployeeBean> retrieveEmployeeDetailsWithInSalaryRange1(Double lowerBound,Double upperBound) throws Exception{
		...
		try {
			...
			Query query = entityManager.createQuery("SELECT e FROM EmployeeEntity e where e.salary>=?1 and e.salary<=?2");  // positional parameters
	...
	public List<EmployeeBean> retrieveEmployeeDetailsWithInSalaryRange2(Double lowerBound,Double upperBound) throws Exception{
		...
		try {
			...
			Query query = entityManager.createQuery("SELECT e FROM EmployeeEntity e where e.salary>= :lb and e.salary<= :ub");  // named parameters
