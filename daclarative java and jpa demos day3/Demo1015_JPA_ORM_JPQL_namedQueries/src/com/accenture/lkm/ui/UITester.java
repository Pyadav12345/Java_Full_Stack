...
public class UITester {
	...
	public static void main(String[] args) {
		try {
			...
			retrieveEmployeeDetailsWithNameLike("%T%");
	...
	static public void retrieveEmployeeDetailsWithNameLike(String namePattern) {
		List<EmployeeBean> employees = null;
		
		EmployeeService employeeService = Factory.createEmployeeService();
		try {
			employees = employeeService.retrieveEmployeeDetailsWithNameLike(namePattern);
			for(EmployeeBean e: employees) {
				System.out.println(e.getEmployeeId()+","+e.getEmployeeName()+","+e.getRole()+","+e.getSalary());
			}
		} catch (Exception e) {
