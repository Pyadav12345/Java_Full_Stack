...
public class ProductUtility {
	public static List<Product> getProductList() {
		...
		products.add(new Product(6, "New IPhone", "N", 90000.0, LocalDate.of(2015, 6, 12)));
		products.add(new Product(7, "New Ipad", "N", 25000.0, LocalDate.of(2015, 6, 12)));
		products.add(new Product(9, "New Fan", "N", 28000.0, LocalDate.now()));
		products.add(new Product(10, "New Table", "N", 28000.0, LocalDate.now()));
