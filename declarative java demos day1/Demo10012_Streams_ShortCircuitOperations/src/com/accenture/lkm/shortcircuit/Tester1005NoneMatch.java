...
public class Tester1005NoneMatch {
	...
	public static void main(String[] args) {
		...
		//        Traverses the entire stream to find mismatch. As all products are having N category, returns true.
		//        Normal flow.
		req1();
	...
	// Comment line no.s 12, 14, 18, 20 in ProductUtility.java
	// Traverse the entire stream to find mismatch. As all products are having N category, returns true.
	// Normal flow.
	//-------------------------------------------------------------------------------------------------
