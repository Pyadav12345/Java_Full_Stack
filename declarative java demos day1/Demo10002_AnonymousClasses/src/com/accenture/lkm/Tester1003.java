...
public class Tester1003 {
	...
	public static void main(String[] args) {
		...
		int numSp = 34;// local variable of main
		...
		int num1 = 10;
		int num2 = 30;
		int sum = executor.execute(addition, num1, num2);   // JVM translates numSp to the literal value at line 15
	}
 ...
 * executor as it is a local variable of main. 
 * 
 * It is because before sending the object and method definition to executor JRE will convert the numSp to
 * respective literal value and then send in order to make this conversion of
 * variable to its literal value. 
 * 
 * numSp should be declared with final keyword in
